...
git -C $Root add evolab/dashboard_data.json evolab/ledger.jsonl evolab/hall_of_fame.json evolab/evolved_strategies.json evolab/picks.json 2>&1 | Add-Content $Log
